...
public class AppointmentRequestServiceImpl implements AppointmentRequestServiceInter {
    ...
    @Override
    public AppointmentRequestResponseDto createRequest(Long midwifeId, Long userId, AppointmentRequestCreateRequestDto request) {
        ...
        List<Appointment> conflicts = appointmentRepository.findByMidwifeAndAppointmentDateAndStartTimeAndStatus(
            midwife,
        ...
        return mapToResponse(appointmentRequestRepository.save(appointmentRequest));
    }
    ...
    public List<AppointmentRequestResponseDto> getRequestsForMidwife(Long midwifeId) {
        ...
        return appointmentRequestRepository.findByMidwifeOrderByRequestedAtDesc(midwife)
            .stream()
    ...
    public AppointmentRequestResponseDto acceptRequest(Long midwifeId, String requestId) {
        ...
        AppointmentRequest appointmentRequest = appointmentRequestRepository.findByRequestIdAndMidwife(requestId, midwife)
        ...
        validateDateTimeNotInPast(appointmentRequest.getAppointmentDate(), appointmentRequest.getStartTime());
    ...
    private AppointmentRequestResponseDto mapToResponse(AppointmentRequest request) {
        ...
        return AppointmentRequestResponseDto.builder()
            ...
            .midwifeId(request.getMidwife() != null ? request.getMidwife().getId() : null)
            .userId(patient != null ? patient.getId() : null)
            .firstName(patient != null ? patient.getFirstName() : null)
            .lastName(patient != null ? patient.getLastName() : null)
            .userEmail(patient != null ? patient.getEmail() : null)
            .appointmentDate(request.getAppointmentDate())
            .startTime(request.getStartTime())
            .endTime(request.getEndTime())
            .appointmentType(request.getAppointmentType())
